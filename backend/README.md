...
## Project Structure
    ...
    ├── testapiautocatalog_110836  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_110836`
...
2. Clone this repo and `cd testapiautocatalog_110836`
